# A2P User Consent Form Inputs for EarnYour Marketing

## 1. How do Contacts Opt-in to Messages?
...
## 2. Opt-in Message
*(Required: 0-320 characters)*

```
You have successfully opted-in to receive marketing and transactional SMS messages from EarnYour Marketing. Reply STOP to unsubscribe at any time. Reply HELP for assistance. Message and data rates may apply.
```
...
## 4. Business Website Compliance Checklist
...
- Includes data rates disclosure
- Includes opt-out instructions (Reply STOP)
- Includes help instructions (Reply HELP)
- Links to Privacy Policy and Terms of Service

✅ **My Terms of Service and Privacy Policy are published and accessible.**
- Privacy Policy: https://earnyour.com/privacy
- Terms of Service: https://earnyour.com/terms
- Both pages contain comprehensive A2P-compliant SMS messaging sections

✅ **My website displays accurate business information (name, address, email, phone).**
- Business Name: EarnYour Marketing
- Address: Tupelo, MS 38801
- Email: hello@earnyour.com
- Phone: (662) 555-0123
- All information is displayed on https://earnyour.com/contact

✅ **My site does not mention purchased or affiliate leads.**
- We do not purchase leads or use affiliate lead generation
- All contacts are self-submitted through our website forms

✅ **Any DBA names used are clearly displayed, if applicable.**
- No DBA names - operating as EarnYour Marketing
